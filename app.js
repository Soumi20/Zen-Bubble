 ...
 passport.deserializeUser(User.deserializeUser());
  ...
  webPush.setVapidDetails('mailto:nandini.jain.cd.eee19@itbhu.ac.in', publicVapidKey, privateVapidKey);
...
io.on('connection', (socket) => {
  ...
  socket.on('joinRoom', ({ username, room }) => {
    ...
    socket.emit('message', formatMessage(botName, 'Welcome to Meditation Zone!'));
